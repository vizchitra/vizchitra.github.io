---
title: Proposal | Dialogues @ VizChitra
description: Guidelines for proposing a dialogue session at VizChitra.
guide: dialogues
section: proposal
order: 1
---
...
Dialogue sessions — previously called _Birds of a Feather (BoF)_ — are participant-driven conversations where people with shared interests in data visualization explore questions together.
...
A strong proposal shows you can frame a meaningful conversation _and_ facilitate it effectively. Focus on clarity of intent and quality of questions. Why is this conversation worth having, and how will you help participants engage productively?
...
| Format               | Description                                              |
| -------------------- | -------------------------------------------------------- |
| Open Question Circle | Poses a core question and guide rotating responses       |
| Experience Exchange  | Participants share short real-world cases and lessons    |
| Problem Clinic       | Volunteers present challenges; group offers perspectives |
| Debate & Contrast    | Structured comparison of differing approaches            |
| Pattern Mining       | Group extracts common patterns across experiences        |
| Future Mapping       | Participants explore scenarios and emerging directions   |
