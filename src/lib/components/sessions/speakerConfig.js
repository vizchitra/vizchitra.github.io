...
export const speakerImageTransforms = {
	'Kenneth Dsouza / Rasagy Sharma': { x: 10, y: -15, scale: 1.3, order: 1 },
	'Areena Arora': { x: 10, y: 25, scale: 1.1, order: 2 },
	'Schubert de Abreu': { x: 14, y: 0, scale: 1.1, order: 3 },
	'Priti Pandurangan': { x: 15, y: 5, scale: 0.9, order: 4 },
	'Adolfo Arranz': { x: 15, y: 0, scale: 1.2, order: 5 },
	'Prakriti Bakshi': { x: 0, y: 32, scale: 1.2, order: 6 },
