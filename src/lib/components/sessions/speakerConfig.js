...
/** @type {Record<string, { x?: string; y?: string; scale?: number }>} */
export const speakerImageTransforms = {
	'Prasanta Kumar Dutta': { x: 5, y: 5, scale: 1 },
	'Schubert de Abreu': { x: 12, y: 2, scale: 0.95 },
	'Prakriti Bakshi': { x: 5, y: 10, scale: 0.95 },
	'Adolfo Arranz': { x: 9, y: 5, scale: 0.9 },
	'Priti Pandurangan': { x: 10, y: -7, scale: 0.96 },
	'Kenneth Dsouza': { x: 15, y: 2, scale: 1 },
	'Areena Arora': { x: 10, y: -20, scale: 1.1 }
};
