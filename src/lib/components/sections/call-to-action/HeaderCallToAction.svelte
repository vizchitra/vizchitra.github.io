    ...
    >
      {#each patterns as CtaPattern}
        <div
          ...
          class="marquee-section text-viz flex w-fit shrink-0 flex-row items-center justify-between gap-sm px-xs"
        >
          <p
            class="cta-text font w-fit px-sm text-base whitespace-nowrap sm:text-lg md:text-xl"
          >
