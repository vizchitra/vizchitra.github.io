...
<div class="playground-container content-container mx-auto px-0 py-xl">
	<p class="content-text mb-xl">
		Play around with the following section to create your own custom VizChitra logo.
	</p>

	<div class="flex flex-col gap-2xl md:flex-row">
		<div class="form-section form flex w-full flex-col gap-md">
			<div class="details-section">
				<div class="section-header mb-sm flex items-center gap-sm">
				...
				<div class="details-controls pl-xl">
					<div class="text-input relative mb-md">
						<input
					...
					<div class="text-input relative mb-sm">
						<textarea
			...
			<button
				class="bg-viz-orange cursor-pointer rounded py-sm font-semibold text-white hover:opacity-90 md:ml-10"
