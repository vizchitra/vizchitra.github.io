...
<div class="content-notice mb-xl grid grid-cols-1 gap-md md:grid-cols-2 md:gap-lg">
...
<Button class_name="w-full" variant="primary" href="https://hasgeek.com/VizChitra/2025/" external>
