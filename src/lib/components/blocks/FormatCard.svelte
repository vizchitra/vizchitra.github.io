...
>
	...
	<div class="mb-sm px-sm pt-sm pb-xs gap-xs grid grid-cols-2 items-baseline">
	...
	<div class="pb-lg relative">
		...
		<!-- Bullet Points -->
		<ul class="px-sm pb-sm space-y-xs.5 relative z-10 text-base leading-relaxed text-black">
			{#each points as point}
				<li class="gap-xs flex items-start">
					<span class="mt-xs.5 h-1.5 w-1.5 shrink-0 rounded-full bg-current"></span>
					<span>{point}</span>
				</li>
			{/each}
		</ul>
