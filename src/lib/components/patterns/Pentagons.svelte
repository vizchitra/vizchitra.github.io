...
<div class="pentagon-card relative mx-auto">
	...
	<div
		class="content p-sm absolute inset-5 z-10 flex flex-col items-center justify-center text-center"
	>
		<h3 class="font-display text-grey-dark mt-xl mb-xs md:mb-sm text-xl font-bold md:text-2xl">
			{title}
		</h3>
