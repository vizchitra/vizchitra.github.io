<script lang="ts">
	...
	const formatColors: Record<Color, string[]> = {
		blue: ['--viz-color-blue-light', '--viz-color-blue', '--viz-color-blue-dark'],
		teal: ['--viz-color-teal-light', '--viz-color-teal', '--viz-color-teal-dark'],
		pink: ['--viz-color-pink-light', '--viz-color-pink', '--viz-color-pink-dark'],
		orange: ['--viz-color-orange-light', '--viz-color-orange', '--viz-color-orange-dark'],
		yellow: ['--viz-color-yellow-light', '--viz-color-yellow', '--viz-color-yellow-dark']
	};
