...
export async function captureNodeAsPNG(element, options = {}) {
	try {
		...
		// Clone the element to avoid modifying original (currently unused but kept for future implementation)
		const _clone = element.cloneNode(true);
