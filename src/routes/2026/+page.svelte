...
<Container>
	...
	<SubHeading class="pb-6">
		...
		>
		returns to <span class="text-viz-orange-dark font-bold">Bangalore</span> on
		<span class="text-viz-pink-dark font-bold">3rd & 4th July, 2026</span>. Join us for
		<span class="text-viz-blue-dark font-bold">two days</span> of learning, sharing, and connecting with
	...
	<FullBleed class="px-4 py-12 md:px-8">
