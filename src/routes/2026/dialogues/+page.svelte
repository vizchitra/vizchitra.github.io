...
<Container>
	<Stack>
		<Prose>
			<h1>Dialogues on 4th July, 2026</h1>
			<p>
				Explore the dialogues lined up for VizChitra 2026 — open conversations between practitioners
				on shared questions.
			</p>
		</Prose>
		...
		{#if data.sessions.length === 0}
			<div class="py-16 text-center">
				<p class="text-viz-grey text-lg">No dialogues found.</p>
			</div>
		{/if}
	</Stack>
</Container>
